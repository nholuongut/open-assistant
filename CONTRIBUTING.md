...
<a href="https://github-com.translate.goog/nholuongut/open-assistant/blob/main/CONTRIBUTING.md?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp">![Translate](https://img.shields.io/badge/Translate-blue)</a>
...
[issues](https://github.com/nholuongut/open-assistant/issues). Find an issue that
...
1.  Package up a small bit of work that solves part of the problem
    ...
    [Here](https://github.com/nholuongut/open-assistant/pull/658) is an example PR
...
- At any point you can compare your feature branch to the upstream/main of
  `nholuongut/open-assistant` by using a URL like this:
  https://github.com/nholuongut/open-assistant/compare/main...andrewm4894:Open-Assistant:my-example-feature-branch.
  ...
  `https://github.com/nholuongut/open-assistant/compare/main...<your_github_username>:Open-Assistant:<your_branch_name>`.
...
- Try not to work on the `main` branch in your fork - ideally you can keep this
  as just an updated copy of `main` from `nholuongut/open-assistant`.
...
[![translation badge](https://inlang.com/badge?url=github.com/nholuongut/open-assistant)](https://inlang.com/editor/github.com/nholuongut/open-assistant?ref=badge)
