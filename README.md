...
<a href="https://github.com/nholuongut/open-assistant/stargazers">![GitHub Repo stars](https://img.shields.io/github/stars/nholuongut/open-assistant?style=social)</a>
...
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/build-frontend.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/build-frontend.yaml?label=build-frontend)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/build-postgres.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/build-postgres.yaml?label=build-postgres)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/pre-commit.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/pre-commit.yaml?label=pre-commit)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/test-api-contract.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/test-api-contract.yaml?label=tests-api)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/test-e2e.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/test-e2e.yaml?label=tests-web)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/deploy-docs-site.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/deploy-docs-site.yaml?label=deploy-docs)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/production-deploy.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/production-deploy.yaml?label=deploy-production)</a>
<a href="https://github.com/nholuongut/open-assistant/actions/workflows/release.yaml">![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/nholuongut/open-assistant/release.yaml?label=deploy-release)</a>
<a href="https://github.com/nholuongut/open-assistant/releases">![GitHub release (latest by date)](https://img.shields.io/github/v/release/nholuongut/open-assistant)</a>
<a href="https://github-com.translate.goog/nholuongut/open-assistant/blob/main/README.md?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp">![Translate](https://img.shields.io/badge/Translate-blue)</a>
